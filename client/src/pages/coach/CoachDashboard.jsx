        ...
        {active ? (
          <>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              ...
              <button onClick={handleToggle} className="cd-card-link" style={{
